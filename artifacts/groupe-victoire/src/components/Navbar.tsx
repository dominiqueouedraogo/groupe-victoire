      ...
      <header className="sticky top-0 z-40 w-full border-b border-gray-100 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 shadow-sm">
        <div className="container flex h-16 items-center justify-between mx-auto px-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" onClick={() => setTheme(theme === "light" ? "dark" : "light")} className="rounded-xl hover:bg-gray-100" aria-label="Changer le theme">
                ...
                <div className="flex flex-col gap-2 mt-8">
                  ...
                  {user ? (
                    <>
                      ...
                      <button onClick={() => setShowSignoutModal(true)} className="text-left px-4 py-2.5 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 transition-colors">Deconnexion</button>
                    </>
                  ) : (
                    <>
                      <div className="border-t border-gray-100 pt-2 mt-2" />
